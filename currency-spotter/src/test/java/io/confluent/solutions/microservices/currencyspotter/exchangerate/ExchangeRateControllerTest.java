...
import io.confluent.solutions.microservices.currencyspotter.CurrencySpotterApplication;
import reactor.test.StepVerifier;

@SpringBootTest(classes = CurrencySpotterApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT, properties = "coinbase.mock.repeat=true")
