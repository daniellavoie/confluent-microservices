...
import io.confluent.solutions.microservices.exchangerate.it.exchangerate.ExchangeRateIntegrationTestsApplication;
import io.confluent.solutions.microservices.exchangerate.it.exchangerate.ExchangeRateListener;
import reactor.core.publisher.Flux;
import reactor.test.StepVerifier;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = ExchangeRateIntegrationTestsApplication.class)
